; A text file is given. Read the content of the file, count the number of vowels and display the result on the screen. 
...
segment data use32 class=data
    file_name db "ex_09_input.txt", 0
    access_mode db "r", 0
    file_desc dd -1
    len equ 100
    text times (len+1) db 0
    format db "We read %d vowels", 0
