; A text file is given. Read the content of the file, count the number of even digits and display the result on the screen. 
...
segment data use32 class=data
    file_name db "ex_11_input.txt", 0
    access_mode db "r", 0
    file_desc dd -1
    len equ 100
    text times (len+1) db 0
    format db "We read %d even digits", 0
segment  code use32 class=code
    start:
        ...
        mov esi, text
        cld
        mov edx, 0 ; number of even digits
