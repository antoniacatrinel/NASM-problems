; Given a file name, a character and a number, display in an output file the characters from the file with the number
; of occurences equal to the read number.
...
segment code use32 class=code
    start:
        ...
        mov ecx, eax     ; length of string read from file
        mov esi, string  ; offset of string read from file
